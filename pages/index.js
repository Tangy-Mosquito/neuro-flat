      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-black text-white px-4">
        <div className="max-w-2xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#" className="bg-white text-black px-6 py-3 rounded-full font-semibold hover:bg-gray-200 transition">Launch App</a>
            <a href="#" className="border border-white px-6 py-3 rounded-full font-semibold hover:bg-white hover:text-black transition">Join Discord</a>
          </div>
        </div>
      </main>
    </>
